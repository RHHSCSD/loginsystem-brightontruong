...
public class NewJFrame extends javax.swing.JFrame {
        ...
        Scanner sc = new Scanner(new File("src/LoginSystem/UserList.txt"));
             ...
             while(sc.hasNextLine()){
                 ...
                 if (parts.length == 6 && parts[0].equals(username)){
                     ...
                     String storedSalt = parts[4];
                    // System.out.println(password + " " + salt);
                     String storedEnpass = parts[3];
                     String enpass = loginSystem.encryption(password, storedSalt);
                     System.out.println(enpass + " " + storedSalt + " " + password);
                     if(storedEnpass.equals(enpass)){
    ...
    createUser signUpPage = new createUser();
